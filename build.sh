...
function check_deps () {
	...
	adddep false "libevent" "src/haapa.c src/proc.c src/result.c src/time.c src/battery.c src/network.c src/exec.c src/format.c src/output.c src/x256.c" "" "" "/usr/include/event.h"
